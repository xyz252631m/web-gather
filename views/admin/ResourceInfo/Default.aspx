<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="admin_ResourceInfo_Default" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link href="../css/blue/List.css" rel="stylesheet" type="text/css"  runat="server" id="list" title="theme" />
    ...
    <script src="../js/Theme.js" type="text/javascript"></script>
        <style>
    .gdtable{table-layout:fixed; width:100%; height:auto;  border:#999 solid 1px;  float:left; margin-top:10px;}
     .gdtable tr{ height:25px; line-height:25px; overflow:hidden; border-bottom:#999 solid 1px;}
      .gdtable td,.gdtable th{height:25px; line-height:25px; width:7%; min-width:7%;text-overflow: ellipsis; text-align:center;
white-space: nowrap;   overflow:hidden; border-right:#999 solid 1px; }
    </style>
    <script>
...
<div id="reslist" runat="server">
    <ul>
        <li  class="licheck"><label>全选</label><input id="allcheckbox" type="checkbox" onclick="AllSelect('reslist')"/></li>
        <li>标题</li>
        <li>类型</li><li>类别</li>
        <li>下载次数</li><li>格式</li>
        <li>添加人</li>
    ...
    <ol>
        ...
        <ItemTemplate>
            ...
            <li class="liright"><a href='ResourceEdit.aspx?id=<%#Eval ("Id")%>'>编辑</a></li>
             ...
             <asp:gridview id="gdlist" runat="server"  CssClass="gdtable" >
        </asp:gridview>
<!--分页-->
    <div>

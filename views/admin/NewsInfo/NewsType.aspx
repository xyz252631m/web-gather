<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsType.aspx.cs" Inherits="admin_NewsInfo_NewsType" %>
...
<div class="alltitle">
    ...
    <input id="btndel" type="button" onclick="delList('admin_NewsInfo_NewsType')" class="btnbor bgdelete" value=" "  />
    </div>
</div>
<!--查询-->
<div  class="selects">
    <div class="select_main">
        <div>
            <input type="text" id="txtNewsType" name="txtNewsType" /><span>资讯类型：</span>
        </div>
    </div>
    <div class="divbotton">    

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SqlBackUp.aspx.cs" Inherits="admin_System_SqlBackUp" %>
...
<div class="alltitle">
    <div class="left"></div>
    <div class="center">数据库备份</div>
    <span>当前位置：系统信息管理>>数据库备份</span>
    <div class="right"></div>
    <div class="titlebtn">
     <asp:Button ID="btnbackup" OnClick="btnBackUp" CssClass="btnbor bgbackup" runat="server" Text=" " /> 
...
<div id="backuplist" runat="server">
    ...
    <ol>
        ...
        <ItemTemplate>
            <li  class="checkthree"><input type="checkbox" value="<%#Eval ("Id")%>,<%#Eval("Bsrc")%>"/></li>
            <li><%#Eval ("Id")%></li>
            <li><%#Eval("BackupTime", "{0:yyyy-MM-dd HH:mm:ss}")%></li>
            <li class="srcli"><%#Eval("Bsrc")%></li>
            <li class="liright" >
            <asp:LinkButton ID="lbtndownload" runat="server" CommandArgument='<%#Eval("Bsrc")%>' onclick="lbtndownload_Click">下载</asp:LinkButton>
       </li>
        </ItemTemplate>
        </asp:Repeater>
    </ol>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MoneyLog.aspx.cs" Inherits="admin_Student_MoneyLog" %>
...
<%--            <input id="btnadd" type="button" onclick="Toolbtnadd(6)" class="btnbor bgadd"  runat="server" value=" " />
   ...
   <div class="select">
    ...
    <!--列表-->
    <div id="divlist" runat="server" class="moneyloglist">
    <ul>
    ...
    <ol>
        ...
        <ItemTemplate>
            ...
            <li  class="liorderno"><%#Eval("OrderNo")%></li>
            <li><%#Eval("TypeName")%></li>
            <li><%#Eval("Price")%></li>
            <li><%#Eval("ConsumeType")%></li>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaseType.aspx.cs" Inherits="admin_BaseInfo_BaseType" %>
...
<div class="alltitle">
    ...
    <span style="text-indent:10px; height:31px; line-height:31px; margin-left:10px;">当前位置：基础信息管理>>分类管理</span>
    <div class="right"></div>
    <div class="titlebtn">
...
<div class="selects">
    <div class="select_main">
        <div>
            <input type="text" id="txtNewsType" name="txtNewsType" /><span>信息类型：</span>
        </div>
    </div>
    <div class="divbotton">    

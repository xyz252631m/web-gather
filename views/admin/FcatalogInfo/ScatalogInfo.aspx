<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScatalogInfo.aspx.cs" Inherits="admin_FcatalogInfo_ScatalogInfo" %>
...
<body >
    ...
    <div class="alltitle"  >
        ...
        <span >当前位置：课程信息管理>>二级目录</span>
        <div class="right"></div>
        <!--标题-->
        <div class="titlebtn">
            <input id="btnselect" type="button" onclick="showbyselect()" class="btnbor bgselect" value=" " />
            <input id="btnadd" type="button" onclick="addbtn('ScatalogEdit')" class="btnbor bgadd"  value=" " />
            <input id="btndel" type="button" onclick="delScatalogInfo()" class="btnbor bgdelete" value=" "  />
        </div>
    </div>
    <!--查询-->
    <div class="select">
    <div class="select_main">
        <div><input type="text" id="txsname" name="txsname" /><span>目录名称：</span></div>
        <div><input type="text" id="txtcname" name="txtcname"/><span>课程名称：</span></div>
        <div><input type="text" id="txfname" name="txfname" /><span>一级目录：</span></div>
        <div>
    ...
    <!--列表-->
    <div id="divlist" runat="server" class="scatlist">
    <ul>
    ...
    <ol>
        ...
        <ItemTemplate>
            <li class="licheck checkthree"><input type="checkbox" value="<%#Eval ("SCatalogId")%>"/></li>
            <li><%#Eval("SCatalogName")%></li>
            <li><%#Eval("Fcatalog.FCatalogName")%></li>
            <li><%#Eval("Fcatalog.CourseInfo.CourseName")%></li>
            <li><%#Eval("Display").ToString() == "True" ? "是" : "否"%></li>
            <li><%#Eval("AddPeople")%></li>
            <li class="litime"><%#Eval("AddTime")%></li>
            <li class="liright">
                <a href='ScatalogEdit.aspx?id=<%#Eval ("SCatalogId")%>'>编辑</a>
            </li>
        </ItemTemplate>
        </asp:Repeater>
    </ol>
